...
class ShowMemories(View):
    def get(self,request,*args,**kwargs):
        ...
        if request.user.is_authenticated:
            ...
            return render(request, "memories/show_memories.html",{"memories": memories,"list_memory_liked_id":list_memory_liked_id}) 
        return render(request, "memories/show_memories.html",{"memories":memories})
...
def add_memory(request):
    ...
    if request.method =="GET":
        ...
        return render(request, 'memories/register_memory.html', context) 
