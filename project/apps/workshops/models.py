...
class WorkshopStatus(models.Model):
    status_code=models.IntegerField(primary_key=True,verbose_name='کدوضعیت')
...
class Workshop (models.Model):
    ...
    image_name=models.ImageField(upload_to=upload_workshop_image,max_length=50,verbose_name='تصویراصلی')
